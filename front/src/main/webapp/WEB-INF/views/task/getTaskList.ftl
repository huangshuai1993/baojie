...
<body>
	            ...
	            <div class="modal-content">
	              ...
	              <div class="modal-body" style='height:140px;'>
	              	 <div class="col-lg-10" style='margin-top: 24px;'>
                        <div class="col-lg-4" style='padding-left:0;'>
                            <select class="form-control" id="region_task_modal" onchange="checkField(this.value,'#storeId_modal')">
                        		<option value="0">请选择</option>
                        		<#list regionAndStore as province>
                            		<option value="${province.region_id}">${province.region_name}</option>
                            	</#list>
                        ...
                        <div class="col-lg-4" style='padding-left:0;'>
                            <select class="form-control" id="storeId_modal" onchange="storeChange(this.value,'#empId_modal')">
                           		<option value="0">请选择</option>
                            </select>
                        </div>
                        <div class="col-lg-4" style='padding-left:0;'>
                            <select class="form-control" id="empId_modal" onchange="empChange(this.value)">
                            	<option value="0">请选择</option>
                            </select>
                        </div>
                    ...
                    <div class="col-lg-10 taskCountDiv" style="display:none;">
                      	  <h6 style="font-weight: bold;">所选的外访人员当前任务量为:<span id="taskCount" style="color:red;"></span>个.</h6>
                    </div>
	              </div>
	              <div class="modal-footer">
	              	<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
    ...
    <script>seajs.use("task/getTaskList.js");seajs.use("common/regionChange.js");</script>
</body>
</html>