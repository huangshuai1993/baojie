...
public interface ConfigService {
	...
	public PageResults<ConfigDetailForm> getAllConfigDetail(Integer pageNumber, Integer pageSize, String configuration,String configDetailDesc) throws BizException; 
